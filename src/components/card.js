...
class Card extends Component {
    ...
    _format(){
        ...
        const figureBounding = this.refs.card.querySelector("figure").getBoundingClientRect()
        const infosBounding = this.refs.card.querySelector(".infos").getBoundingClientRect()
