...
class About extends Component {
    ...
    componentDidMount(){
        const panelWidth = document.querySelector(".panel-btn").getBoundingClientRect().width
    ...
    _format(){
        ...
        if(panelActive){
            const accordionWidth = document.querySelector("#accordion").getBoundingClientRect().width
    ...
    _toggleSection(slug){
        ...
        const accordionWidth = document.querySelector("#accordion").getBoundingClientRect().width
        const panel = document.querySelector(".panel-header.panel-"+slug).parentNode
        ...
        if(panel.classList.contains("active")){
            ...
            document.querySelectorAll(".panel:not(.active)").forEach((el, i) => {
                el.style.right = (i * panelWidth)+"px"
            })
    ...
    render() {
        ...
        return (
            <div className={"about "+_className}>
                ...
                <div 
                    className="about-toggle panel-btn "
                    ...
                    <div className="inner">
                        ...
                        <div className="row">
                            <div className="col-xs-12 col-md-6">
                                <div className="texte fS"
                                    dangerouslySetInnerHTML={{ __html: about.texte.childMarkdownRemark.html }}></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div id="accordion"> 
                    ...
                    {menu.map((li,i) => (
                        <div 
                            ...
                            <div 
                                className={"panel-header panel-btn panel-"+li.slug}
                                style={{
                                    transitionDelay: "."+i+"s"
                                }}
                                onClick={() => this._toggleSection(li.slug)}>
                                    <div className="title serif fXL">{li.title}</div>
                                    {li.slug === "fonts" &&
                                        <FoundrySvg />
                                    }
                            </div>
