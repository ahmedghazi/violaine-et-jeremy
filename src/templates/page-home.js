...
class PageHome extends React.Component {
  ...
  _resize(){
    ...
    const scrollerWidth = document.querySelector(".projects-coverflow").getBoundingClientRect().width - cardLeft
    this.setState({
      ...
      <>
        <div className="home">
          ...
          <div className="projects-coverflow" ref="scroller">
            {!isTouch &&
              <Interactive draggable={true} draggableOptions={draggableOptions}>
